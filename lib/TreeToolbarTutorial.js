...
export class TreeToolbarTutorial extends Tutorial {
	...
	pageStart() {
		...
		this.dialog = atom.notifications.addInfo(dedent`
			<h3>(1/9) Thank you for installing bg-tree-view-toolbar.</h3>
			<p>You should now see a new toolbar at the top of the tree-view pane. Use \`tree-view:show\` to open the tree view.
			</p>
	...
	page4() {
		if (this.dialog) this.dialog.dismiss();
		this.dialog = atom.notifications.addInfo(dedent`
			<h3>(4/9) Dynamic Extensions to Tree-View 1/3</h3>
	...
	page5() {
		if (this.dialog) this.dialog.dismiss();
		this.dialog = atom.notifications.addInfo(dedent`
			<h3>(5/9) Dynamic Extensions to Tree-View 2/3</h3>
	...
	page6() {
		if (this.dialog) this.dialog.dismiss();
		this.dialog = atom.notifications.addInfo(dedent`
			<h3>(6/9) Dynamic Extensions to Tree-View 3/3</h3>
	...
	page9() {
		...
		// 	<h3>That's it</h3>
		// 	<p>
		// 	If you have any questions or comments, please click on the \`Report Issues\` button near the top of the settings page.
		// 	</p>
		// 	`, {
		// 	dismissable: true,
		// 	buttons: [
