...
export class TreeToolbarView {
	constructor(parent) {
		...
		this.el = el("div.bg-tree-view-toolbar.bg-toolbar.tool-panel.panel-heading")
		...
		this.disposables.add(atom.commands.add('atom-workspace', "bg-tree-view:collapse-to-root-level", ()=>this.btnHidden.onClick()));
