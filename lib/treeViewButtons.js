...
export class BoolConfigToggle extends ToggleButton {
	constructor(bgNodeID, configKey, ...p) {
		// ' '+configKey is the default label. The leading space makes it a bgNodeID with only a label
		super(bgNodeID, ...p, ' '+configKey);
		this.negate = false; // when negate is false, (state!=negate) will have the same value as state. When its true, it will be negated.
...
export class PackageConfigButton extends Button {
	constructor(bgNodeID, packageName, ...p) {
		super(bgNodeID, ...p, 'icon-gear');
...
export class HiddenFilesToggle extends BoolConfigToggle {
	constructor(bgNodeID, ...p) {
		// '  .*' is the default label
		super(bgNodeID, '!tree-view.hideIgnoredNames', ...p, '  .*');
...
export class TreeViewAutoTrackToggle extends BoolConfigToggle {
	constructor(bgNodeID, ...p) {
		// ' Auto Track' is the default label
		super(bgNodeID, 'tree-view.autoTrackActivePane.enabled', ...p, ' Auto Track');
...
export class FontSizeButtonGroup extends ToolGroup {
	constructor(bgNodeID, ...p) {
		super(bgNodeID, '.FontSizeButtonGroup', ...p)
		this.mount([
