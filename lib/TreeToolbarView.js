...
export class TreeToolbarView extends Component {
	constructor(isShown, ...p) {
		...
		this.disposables.add(atom.commands.add('atom-workspace', "bg-tree-view:toggle-auto-reveal",     ()=>this.btnTrack.onClick()));
		...
		atom.workspace.addDep_items("atom://tree-view", this, (...p)=>{this.onTreeViewStateChange(...p);});
