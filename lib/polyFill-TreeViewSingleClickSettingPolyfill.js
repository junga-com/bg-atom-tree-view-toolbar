...
export class TreeViewSingleClickSettingPolyfill extends PolyfillObjectMixin {
	constructor(configKey) {
		...
		atom.workspace.addDep_itemOpened("atom://tree-view", this, ()=>{this.sync();});
